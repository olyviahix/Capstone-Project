...
function PostContent(props) {
  ...
  const [iconClass, setIconClass] = useState("bi bi-heart icon-interact")
...
const removePost = async () => {
    ...
    if(props.username === user){
      ...
      setDeleteOptions(<li onClick={deletePost}>Delete Post</li>)
      
    }else {
      setDeleteOptions(<li onClick={()=>{console.log('post unliked')}}>Unlike post</li>)
  ...
  return (
    ...
    <Card className="userPost">
      ...
      <Card.Body class="post-icons">
        ...
        <i class={iconClass} style={{color: 'red'}} onClick={onNotify}></i>
        <div className="toggle-btn" onClick={respToggle}>
          <i class="bi bi-three-dots" onClick={removePost}></i>
        </div>
      </Card.Body>
    </Card>
